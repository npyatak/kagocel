...
class PostAction extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            ['type', 'in',  'range' => [self::TYPE_LIKE, self::TYPE_SHARE_VK, self::TYPE_SHARE_FB, self::TYPE_SHARE_OK]],
            [['user_id', 'post_id', 'type'], 'unique', 'targetAttribute' => ['user_id', 'post_id', 'type']],
        ];
    }
    ...
    public static function getTypeArray() {
        return [
            ...
            self::TYPE_SHARE_OK => 'Поделиться OK',
        ];
    }
    ...
    public function getTypeScores() {
        return [
            self::TYPE_LIKE => 1,
            self::TYPE_SHARE_VK => 5,
            self::TYPE_SHARE_FB => 5,
            self::TYPE_SHARE_OK => 5,
        ];
    }
